    ...
    <div class="row">
        ...
        <div class="col-8">
            <div class="row">
                ...
                <form action="<?= site_url("discs/delete_form/").$disc->disc_id ?>" class="col-12" enctype="multipart/form-data" method="POST">
                    <div class="col-12">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-danger">Supprimer le disque</button>
                    <a href="<?= site_url('discs/detail/') .  $disc->disc_id?>" class="btn btn-success" role="button">Retour aux details</a>
